    ...
    <div class="container">
        ...
        <div class="dashboard-grid">
            ...
            <div class="quick-actions">
                ...
                <a href="{{ route('admin.alerts.create') }}" class="action-btn danger">🚨 Create New Alert</a>
                <a href="{{ route('admin.shelters.create') }}" class="action-btn success">🏠 Add New Shelter</a>
                ...
                <a href="{{ route('admin.analytics') }}" class="action-btn">📊 View Analytics</a>
                <a href="{{ route('admin.shelters') }}" class="action-btn">🗺️ Map Overview</a>
